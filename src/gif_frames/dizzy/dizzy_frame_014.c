/*
 * LVGL Image Frame: dizzy_frame_014
...
const lv_image_dsc_t dizzy_frame_014 = {
  .header = {
  ...
  .data_size = sizeof(dizzy_frame_014_map),
  .data = dizzy_frame_014_map,
  .reserved = NULL,
};
